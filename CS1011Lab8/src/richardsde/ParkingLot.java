...
public class ParkingLot {
    ...
    /**
     * Displays the name of the parking lot and the percentage of parking spots that have
     * been taken, unless the lot is closed, in which case 'CLOSED' is printed out instead.
     */
    public void displayStatus(){
        ...
        if (isClosed()){
            ...
            System.out.printf("Percentage full: %.1f%% \n", getPercentFull());
        }
    } // end displayStatus
